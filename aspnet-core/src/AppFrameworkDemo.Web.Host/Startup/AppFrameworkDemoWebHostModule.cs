...
namespace AppFramework.Web.Startup
{
    ...
    public class AppFrameworkDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AppFrameworkDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppFrameworkDemoWebHostModule).GetAssembly());
        }
