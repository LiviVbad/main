...
namespace AppFramework.Web.Public.Startup
{
    ...
    public class AppFrameworkDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AppFrameworkDemoWebFrontEndModule(IWebHostEnvironment env, AppFrameworkDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppFrameworkDemoWebFrontEndModule).GetAssembly());
        }
    }
}
