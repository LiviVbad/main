...
namespace AppFramework
{
    ...
    public class AppFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            AppFrameworkDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, AppFrameworkDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<AppFrameworkDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
