...
/// </summary>
public static class AppFrameworkDemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, AppFrameworkDemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
