...
namespace AppFrameworkDemo.Test.Base
{
    ...
    public class AppFrameworkDemoTestBaseModule : AbpModule
    {
        public AppFrameworkDemoTestBaseModule(AppFrameworkDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("AppFrameworkDemoEntities", typeof(User), typeof(Tenant));
        }
